 ...
 */
public class UMLMachineApplet extends JApplet {

    private final static String NAME = "JHotDraw Pert";
    private UMLMachinePanel drawingPanel;
    ...
    protected String getVersion() {
        return UMLMachineApplet.class.getPackage().getImplementationVersion();
    }
    ...
    @Override
            public Drawing construct() throws IOException {
                ...
                if (getParameter("data") != null) {
                    NanoXMLDOMInput domi = new NanoXMLDOMInput(new UMLMachineFactory(), new StringReader(getParameter("data")));
                    result = (Drawing) domi.readObject(0);
                } else if (getParameter("datafile") != null) {
                    URL url = new URL(getDocumentBase(), getParameter("datafile"));
                    InputStream in = url.openConnection().getInputStream();
                    try {
                        NanoXMLDOMInput domi = new NanoXMLDOMInput(new UMLMachineFactory(), in);
                        result = (Drawing) domi.readObject(0);
                    } finally {
                        in.close();
                    }
            ...
            protected void done(Drawing result) {
                ...
                c.removeAll();
                c.add(drawingPanel = new UMLMachinePanel());
    ...
    public String getData() {
        ...
        try {
            NanoXMLDOMOutput domo = new NanoXMLDOMOutput(new UMLMachineFactory());
    ...
    @Override
            public void run() {
                ...
                UMLMachineApplet a = new UMLMachineApplet();
